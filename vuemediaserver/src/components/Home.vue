            ...
            <!-- <div class="page-container">
              <div class="result">
                <div v-for="anime in data.anime" :key="anime._id" class="result-map">
                  <a v-bind:href="/anime/+anime._id+'/'+anime.titles[0].romaji.replace(/ /g,'_')"><img v-bind:src="anime.images[0].cover" class="imgmap"><div><p class="texttop">{{anime.titles[0].romaji}}</p></div></a>
                </div>
              </div>
            </div> -->
          </div>
