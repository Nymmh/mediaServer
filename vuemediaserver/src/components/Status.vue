<template>
    <div class="main">
        <div class="page-container">
            <div class="result">
                <div class="result-year"><a href="/status/FINISHED"><div class="spanbg"><p class="texttop-year">Finished</p></div></a></div>
                <div class="result-year"><a href="/status/RELEASING"><div class="spanbg"><p class="texttop-year">Releasing</p></div></a></div>
            </div>
        </div>
        <template v-if="statusSearch">
            <ApolloQuery :query="require('../graphql/statusAnime.gql')" :variables="{status:statusSearch}">
