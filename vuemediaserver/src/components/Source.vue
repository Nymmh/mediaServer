<template>
    <div class="main">
        <div class="page-container">
            <div class="result">
                <div class="result-year"><a href="/source/ORIGINAL"><div class="spanbg"><p class="texttop-year">Original</p></div></a></div>
                <div class="result-year"><a href="/source/MANGA"><div class="spanbg"><p class="texttop-year">Manga</p></div></a></div>
                <div class="result-year"><a href="/source/LIGHT_NOVEL"><div class="spanbg"><p class="texttop-year">Light Novel</p></div></a></div>
                <div class="result-year"><a href="/source/VISUAL_NOVEL"><div class="spanbg"><p class="texttop-year">Visual Novel</p></div></a></div>
                <div class="result-year"><a href="/source/VIDEO_GAME"><div class="spanbg"><p class="texttop-year">Video Game</p></div></a></div>
                <div class="result-year"><a href="/source/OTHER"><div class="spanbg"><p class="texttop-year">Other</p></div></a></div>
                <div class="result-year"><a href="/source/NOVEL"><div class="spanbg"><p class="texttop-year">Novel</p></div></a></div>
                <div class="result-year"><a href="/source/DOUJINSHI"><div class="spanbg"><p class="texttop-year">Doujinshi</p></div></a></div>
                <div class="result-year"><a href="/source/ANIME"><div class="spanbg"><p class="texttop-year">Anime</p></div></a></div>
                <div class="result-year"><a href="/source/UNKNOWN"><div class="spanbg"><p class="texttop-year">Unknown</p></div></a></div>
            </div>
        </div>
        <template v-if="sourceSearch">
            <ApolloQuery :query="require('../graphql/sourceAnime.gql')" :variables="{source:sourceSearch}">
