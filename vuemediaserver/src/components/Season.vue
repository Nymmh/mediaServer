<template>
    <div class="main">
        <div class="page-container">
            <div class="result">
                <div class="result-year"><a href="/season/WINTER"><div class="spanbg"><p class="texttop-year">Winter</p></div></a></div>
                <div class="result-year"><a href="/season/SPRING"><div class="spanbg"><p class="texttop-year">Spring</p></div></a></div>
                <div class="result-year"><a href="/season/SUMMER"><div class="spanbg"><p class="texttop-year">Summer</p></div></a></div>
                <div class="result-year"><a href="/season/FALL"><div class="spanbg"><p class="texttop-year">Fall</p></div></a></div>
                <div class="result-year"><a href="/season/UNKNOWN"><div class="spanbg"><p class="texttop-year">Unknown</p></div></a></div>
            </div>
        </div>
        <template v-if="seasonSearch">
            <ApolloQuery :query="require('../graphql/seasonAnime.gql')" :variables="{season:seasonSearch}">
