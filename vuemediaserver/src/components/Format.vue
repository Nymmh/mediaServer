<template>
    <div class="main">
        <div class="page-container">
            <div class="result">
                <div class="result-year"><a href="/format/TV"><div class="spanbg"><p class="texttop-year">TV</p></div></a></div>
                <div class="result-year"><a href="/format/TV_SHORT"><div class="spanbg"><p class="texttop-year">TV Short</p></div></a></div>
                <div class="result-year"><a href="/format/MOVIE"><div class="spanbg"><p class="texttop-year">Movie</p></div></a></div>
                <div class="result-year"><a href="/format/SPECIAL"><div class="spanbg"><p class="texttop-year">Special</p></div></a></div>
                <div class="result-year"><a href="/format/OVA"><div class="spanbg"><p class="texttop-year">OVA</p></div></a></div>
                <div class="result-year"><a href="/format/ONA"><div class="spanbg"><p class="texttop-year">ONA</p></div></a></div>
                <div class="result-year"><a href="/format/MUSIC"><div class="spanbg"><p class="texttop-year">Music</p></div></a></div>
                <div class="result-year"><a href="/format/UNKNOWN"><div class="spanbg"><p class="texttop-year">Unknown</p></div></a></div>
            </div>
        </div>
        <template v-if="formatSearch">
            <ApolloQuery :query="require('../graphql/formatAnime.gql')" :variables="{format:formatSearch}">
